...
{
	$(this.buttons.undo).toggleClass("tool-button-disabled", this.mol.stack.length === 0);
	$(this.buttons.redo).toggleClass("tool-button-disabled", this.mol.reverseStack.length === 0);
