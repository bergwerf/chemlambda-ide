...
MolPad.prototype.setupEventHandling = function()
{
	...
	{
		$(document).bind("keydown", "meta+z", function(e)
				{ e.preventDefault(); scope.undo(); });
		$(document).bind("keydown", "meta+y", function(e)
				{ e.preventDefault(); scope.redo(); });
		$(document).bind("keydown", "meta+shift+z", function(e)
				{ e.preventDefault(); scope.redo(); });
	}
	else
	{
		...
		$(document).bind("keydown", "ctrl+y", function(e)
				{ e.preventDefault(); scope.redo(); });
		$(document).bind("keydown", "ctrl+shift+z", function(e)
				{ e.preventDefault(); scope.redo(); });
	}
